...
# Ensure results is defined globally to avoid NameError
results = []
...
def process_scene(i, scene):
    ...
    # Stable Render (Color block fallback for stable concatenation)
...
# Re-encode instead of copy to fix black screen
...
# Final Merge with explicit codec re-encoding
subprocess.run([
